...
const Photo = () => {
      ...
      <div className="min-h-screen bg-black">
        ...
        <div className="container mx-auto px-3 sm:px-4 py-6 sm:py-8">
          <div className="text-center mb-8 sm:mb-12">
            <h1
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-white via-gray-300 to-white bg-clip-text text-transparent"
              style={{
            ...
            <div className="h-6 bg-gray-800 rounded w-64 mx-auto mb-8 animate-pulse" />
          </div>
          ...
          <div className="flex justify-center mb-6 sm:mb-10">
            <div className="flex gap-2 sm:gap-4">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="h-10 w-20 sm:w-24 bg-gray-800 rounded-full animate-pulse" />
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-4 md:gap-6">
            {Array.from({ length: 8 }).map((_, index) => (
              <div key={index} className="aspect-square bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-xl sm:rounded-none animate-pulse">
  ...
  return (
    <>
      ...
      {/* Header */}
      <div className="container mx-auto px-4 sm:px-3 py-4 sm:py-6">
        <motion.div
        ...
        {currentItems.length > 0 ? (
          <motion.div
            ...
            className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-4 md:gap-6"
          >
            {currentItems.map((product, index) => (
              ...
              >
                <div className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 aspect-square shadow-2xl rounded-xl sm:rounded-none">
        ...
        {totalPages > 1 && (
          <motion.div
            ...
            className="flex justify-center items-center mt-12 sm:mt-16 space-x-2 sm:space-x-4"
          >
            {/* Previous Button */}
            <motion.button
