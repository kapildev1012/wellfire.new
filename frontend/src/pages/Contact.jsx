...
const Contact = () => {
  ...
  return (
    <div 
      className="min-h-screen bg-gradient-to-br bg-black text-white"
    ...
    >
      ...
      <div className="bg-black/50 backdrop-blur-sm py-4 sm:py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className={`text-gray-400 mb-6 ${isMobile ? 'text-xs px-4' : 'text-base'}`}>
            {isMobile ? (
      ...
      <div className="py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          ...
          {showPreview && (
            <div className={`mb-${isMobile ? '6' : '8'} bg-gray-800/20 rounded-xl p-${isMobile ? '4' : '6'} border border-gray-700/30`}>
              <h3 className={`font-semibold mb-${isMobile ? '3' : '4'} ${isMobile ? 'text-sm' : 'text-lg'}`}>
                 Application Preview
              </h3>
          ...
          <div className={`bg-gray-800/30 backdrop-blur-sm rounded-xl p-${isMobile ? '4' : '6'} sm:p-6 lg:p-8 border border-gray-700/50 shadow-2xl`}>
            {currentStep === 1 ? (
