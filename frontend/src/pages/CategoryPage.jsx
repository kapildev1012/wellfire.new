...
const CategoryPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black">
      {/* Header Section */}
      <div className="relative bg-gradient-to-b from-gray-900 to-black px-3 sm:px-6 pt-6 pb-8">
      ...
      <div className="px-3 sm:px-6 mb-6">
        <div className="relative max-w-md mx-auto">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 text-sm bg-gray-900 text-white border border-gray-700 rounded-xl shadow-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-300 placeholder-gray-400"
          />
          {searchTerm && (
            <button
      ...
      <div className="px-3 sm:px-6 pb-8">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            <div className="w-24 h-24 sm:w-32 sm:h-32 bg-gray-800 rounded-full flex items-center justify-center mb-6">
              <svg
            ...
            {searchTerm && (
              <button
                onClick={() => setSearchTerm("")}
                className="mt-6 px-6 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-lg transition-colors duration-200"
              >
                Clear Search
              </button>
            )}
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-6">
              {filteredProducts.map((item, index) => (
                ...
                >
                  <div className="bg-gray-900 rounded-xl overflow-hidden border border-gray-800 hover:border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300">
                    <ProductItem
      ...
      {isMobile && filteredProducts.length > 6 && (
        <div className="fixed bottom-6 right-4 z-50">
          <button
            ...
            className="w-12 h-12 bg-red-600 hover:bg-red-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center"
          >
            <svg
              className="w-5 h-5"
              fill="none"
