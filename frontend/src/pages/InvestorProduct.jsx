    ...
    <div className="min-h-screen bg-black text-white">
      <div
        className={`w-full max-w-6xl mx-auto ${
          isMobile ? "px-4 py-8" : "px-6 md:px-8 py-12 lg:py-16"
        }`}
      >
        {/* Header Section */}
        <div className={`text-center ${isMobile ? "mb-10" : "mb-16"}`}>
          <div
            className={`flex items-center justify-center ${
              isMobile ? "flex-col gap-8" : "gap-12 lg:gap-16 mb-8 lg:mb-12"
            }`}
          >
            {/* Mobile: Title First */}
            ...
            <div
              className={`bg-red-500 rounded-full flex items-center justify-center flex-shrink-0 ${
                isMobile ? "w-24 h-24 sm:w-28 sm:h-28" : "w-32 h-32 md:w-40 md:h-40 lg:w-48 lg:h-48"
              }`}
            >
              <svg
                className={`text-white ${isMobile ? "w-10 h-10 sm:w-12 sm:h-12" : "w-16 h-16 md:w-20 md:w-20 lg:w-24 lg:h-24"}`}
                fill="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        <form
          ...
          className={`space-y-${isMobile ? "5" : "6"} max-w-4xl mx-auto`}
        >
          {/* Name and Email Row */}
          <div
            className={`grid gap-${isMobile ? "5" : "6"} ${
          ...
          <div className={`text-center ${isMobile ? "pt-6" : "pt-8"}`}>
            <button
              ...
              className={`bg-red-500 hover:bg-red-600 text-white font-semibold rounded-full transition-all duration-300 transform ${
                ...
                isMobile ? "px-8 py-4 text-base sm:text-lg w-full max-w-sm sm:max-w-md" : "px-16 py-5 text-lg md:text-xl"
              }`}
            >
