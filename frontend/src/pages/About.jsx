          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-16 lg:gap-20">
            ...
            >
              ...
              >
                ...
                >
                  {"Wellfire Media is where art, business, and bold imagination collide. We are a next-gen creative powerhouse building films, digital media, and lifestyle experiences that inspire and disrupt. Driven by a first-mover spirit, we stand at the intersection of film, digital, and real estate, creating ecosystems where art becomes business and business becomes culture.".split(" ").map((word, index) => (
                    <motion.span
                      key={index}
                ...
                >
                  {"At Wellfire, we don't just make content We create experiences that last.".split(" ").map((word, index) => (
                    <motion.span
                      key={index + 50}
                      initial={{ opacity: 0, y: 10 }}
                      animate={{ opacity: 1, y: 0 }}
