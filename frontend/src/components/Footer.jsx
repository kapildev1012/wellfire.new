...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      {/* Main content */}
      <div className="relative min-h-[60vh] flex items-center justify-center px-4 sm:px-8 lg:px-12">
          ...
          <div className={`space-y-8 transform transition-all duration-1000 delay-400 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}>
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-6">
              <button
                ...
                className="group relative px-6 py-3 border-2 border-white text-white font-medium text-sm tracking-wide uppercase transition-all duration-300 hover:bg-white hover:text-black"
              >
